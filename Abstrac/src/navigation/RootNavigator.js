...
import FrameMarketScreen from '../screens/FrameMarketScreen';
...
// Create header component - removed useNavigation hook to prevent crashes
...
const RootNavigator = ({ user }) => {
  ...
  return (
    <Stack.Navigator initialRouteName="LoginScreen">
      ...
      <Stack.Screen name="CreateChallenge" component={CreateChallengeScreen} options={{ headerShown: true, headerRight: HeaderRight, headerStyle: { backgroundColor: '#000000' }, headerTintColor: '#ffffff' }} />
      ...
      <Stack.Screen name="Frame_Market" component={FrameMarketScreen} options={{ headerShown: true, headerRight: HeaderRight, headerStyle: { backgroundColor: '#000000' }, headerTintColor: '#ffffff' }} />
