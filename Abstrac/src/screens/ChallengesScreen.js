...
import { Modal, Animated, FlatList, StyleSheet, Text, TouchableOpacity, View, ScrollView, Image, TextInput } from 'react-native';
...
// Custom DropdownPicker component to replace the incompatible Picker
const DropdownPicker = ({ selectedValue, onValueChange, options, style }) => {
  ...
  return (
    <>
      <TouchableOpacity
        style={[style || styles.miniPicker]}
        onPress={() => setModalVisible(true)}
      >
        <Text style={{ color: '#FFFFFF', fontSize: 16 }}>{selectedOption.label}</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  // Modal styles for DropdownPicker
  modalOverlay: {
    flex: 1,
